...
function showNewProducts(productsObj) {
    ...
    for(let i = 0; i < productsObj.products.length; i++) {
      ...
      productItem.innerHTML = ` <aside class="product__img-wrapper">
       <div class="product__label">
         Best Seller
       </div>
       <img class="product__img" src="${product.thumbnail}" />
       <button data-product=${stringProduct} class="cartbtn product_cardbtn"> Add to cart</button>
...
function showProductsInCart() {
    document.getElementById("cartproduct__count").innerText = cartArr.length; 
 }
